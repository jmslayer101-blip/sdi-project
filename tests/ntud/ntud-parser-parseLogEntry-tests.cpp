...
{
    const std::string logEntryRawText = "@NUNO<+45.67,-23.24,231.56,40mph>12;";
...
{
    const std::string logEntryRawText = "@XXXX<>12;";
...
{
    const std::string logEntryRawText = "@XXXX<abc,,20,>4E;";
