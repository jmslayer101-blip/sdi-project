...
{
    const LogEntry theLogEntry = { "ISMAHANE", {"78o36'45''","N","23o33'56''","W","23.62"} };
...
{
    const LogEntry theLogEntry = { "ISMAHANE", {"22o47'03''","S","38o14'43''","E","467.21"} };
...
{
    const LogEntry theLogEntry = { "ISMAHANE", {"78o36'45''","N","123o33'56''","W","23.62"} };
    const degrees expectedLatitude = 78.6125;
...
{
    const LogEntry theLogEntry = { "ISMAHANE", {"22o47'03''","S","-38o14'26","E","467.21"} };
...
{
    const LogEntry theLogEntry = { "ISMAHANE", {"22o47'03''","S","3814'26''","E","467.21"} };
...
{
    const LogEntry theLogEntry = { "ISMAHANE", {"22o47'03''","S","38o1426''","E","467.21"} };
...
{
    const LogEntry theLogEntry = { "ISMAHANE", {"22o47'03''","S","over there","E","467.21"} };
...
{
    const LogEntry theLogEntry = { "ISMAHANE", {"22o47'03''","N","38o14'43''","Y","467.21"} };
...
{
    const LogEntry theLogEntry = { "ISMAHANE", {"2247'03''","S","38o14'26''","E","467.21"} };
...
{
    const LogEntry theLogEntry = { "ISMAHANE", {"22o4703''","S","38o14'26''","E","467.21"} };
...
{
    const LogEntry theLogEntry = { "ISMAHANE", {"up here","S","38o14'26''","E","467.21"} };
...
{
    const LogEntry theLogEntry = { "ISMAHANE", {"22o47'03''","X","38o14'43''","E","467.21"} };
...
{
    const LogEntry theLogEntry = { "ISMAHANE", {"22o47'03''","n","38o14'43''","e","467.21"} };
...
{
    const LogEntry theLogEntry = { "ISMAHANE", {"22o47'03''","Nowhere","38o14'43''","Wherever","467.21"} };
